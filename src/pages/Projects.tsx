              ...
              {projects.map((project, projectIndex) => (
                ...
                >
                  ...
                  <div className="relative bg-white rounded-3xl p-8 md:p-12 shadow-xl border border-gray-100">
                    ...
                    {/* Gizlilik Politikası Butonu - Sadece Airy projesi için */}
                    {project.id === 'airy' && (
                      <motion.div
                      ...
                      >
                        <Link
                          to={`/privacy-policy/${project.id}`}
                          className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-accent to-light text-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300"
                        >
                          <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                          </svg>
                          {t('projectsPage.common.privacyPolicy')}
                        </Link>
                      </motion.div>
                    )}
                  </div>
